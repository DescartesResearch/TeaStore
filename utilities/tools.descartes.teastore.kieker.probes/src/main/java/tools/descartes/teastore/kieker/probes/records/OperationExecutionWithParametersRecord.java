...
public class OperationExecutionWithParametersRecord extends OperationExecutionRecord
	...
	/** property name array. */
	private static final String[] PROPERTY_NAMES = { "operationSignature", "sessionId", "traceId", "tin", "tout",
			"hostname", "eoi", "ess", "parameterTypes", "parameterValues", "returnType", "returnValue", };
	 ...
	 * @param returnValue
	 */
	public OperationExecutionWithParametersRecord(final String operationSignature, final String sessionId,
			final long traceId, final long tin, final long tout, final String hostname, final int eoi, final int ess,
			final String[] parameterTypes, final String[] parameterValues, final String returnType,
	...
	public void serialize(final IValueSerializer serializer) throws BufferOverflowException {
		...
		// store array sizes
		int _values_size0 = this.getParameterValues().length;
	...
	public boolean equals(final Object obj) {
		...
		// get array length
		int _values_size0 = this.getParameterValues().length;
		if (_values_size0 != castedRecord.getParameterValues().length) {
			return false;
		}
		for (int i0 = 0; i0 < _values_size0; i0++)
