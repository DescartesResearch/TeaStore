 ...
 */
package tools.descartes.petstore.entities;
...
public class Order {
	...
	/**
	 * Get the time of order (ISO formatted).
	 * Formatted using {@link DateTimeFormatter.ISO_LOCAL_DATE_TIME}.
	 * @return the time.
	 */
	...
	/**
	 * Set the time of order (ISO formatted).
	 * Format using {@link DateTimeFormatter.ISO_LOCAL_DATE_TIME}.
	 ...
	 * @param totalPriceInCents the totalPriceInCents to set.
	 */
	...
	/**
	 * Get the credit card expiry date (ISO formatted).
	 * Formatted using {@link DateTimeFormatter.ISO_LOCAL_DATE}.
	...
	/**
	 * Set the credit card expiry date (ISO formatted).
	 * Format using {@link DateTimeFormatter.ISO_LOCAL_DATE}.
