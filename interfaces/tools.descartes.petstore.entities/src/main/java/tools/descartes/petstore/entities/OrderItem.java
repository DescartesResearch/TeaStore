...
public class OrderItem {
	 ...
	 * @param orderItem The entity to Copy.
	 */
	 ...
	 * @param unitPriceInCents Price per single item.
	 */
	...
	/**
	 * Sets the ID of the order item's order.
	 * Persistence requires that every order item MUST have a valid order ID.
	 * For persistence the order must already exist in database.
