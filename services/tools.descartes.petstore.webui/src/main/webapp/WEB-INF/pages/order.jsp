		...
		<div class="row">
			<div class="col-sm-6 col-lg-4">
				...
				<div class="form-group row">
					<label for="firstname"
						class="col-sm-4 col-md-3 col-form-label col-form-label-lg">First
						Name</label>
				...
				<div class="form-group row">
					<label for="lastname"
						class="col-sm-4 col-md-3 col-form-label col-form-label-lg">Last
						Name</label>
					<div class="col-sm-8 col-md-9">
						<input type="text" class="form-control form-control-lg"
				...
				<div class="form-group row">
					<label for="address1"
						class="col-sm-4 col-md-3 col-form-label col-form-label-lg">Address
						1</label>
					<div class="col-sm-8 col-md-9">
						<input type="text" class="form-control form-control-lg"
				...
				<div class="form-group row">
					...
					<div class="col-sm-8 col-md-9">
						<input type="text" class="form-control form-control-lg"
							name="address2" id="address2" placeholder="MS UCUP02-206" value="11111 The North, Westeros" required>
					</div>
				</div>
			</div>
			<div class="col-sm-6 col-lg-4">
				...
				<div class="form-group row">
					<label for="cardtype"
						class="col-sm-4 col-md-3 col-form-label col-form-label-lg">Card
						Type</label>
					<div class="col-sm-8 col-md-9">
				...
				<div class="form-group row">
					<label for="expirydate"
						class="col-sm-4 col-md-3 col-form-label col-form-label-lg">Expiry
						Date (MM/YYYY)</label>
					<div class="col-sm-8 col-md-9">
						<input type="text" class="form-control form-control-lg"
