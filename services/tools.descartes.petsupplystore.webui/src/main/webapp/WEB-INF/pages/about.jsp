		...
		<div class="col-sm-12 col-md-12">
			...
			<blockquote>
				<small><cite title="Source Title"> Our research is
						...
						systems , spanning the following research areas: 
						<ol>
						...
						We are focussing on system performance, reliability and energy-efficiency, while considering the following application and technology domains:
						<ul>
