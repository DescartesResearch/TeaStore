...
import tools.descartes.petsupplystore.persistence.daemons.InitialDataGenerationDaemon;
...
public abstract class AbstractRecommenderRestTest {
	...
	public void setup() throws Throwable {
		...
		Context context3 = testTomcat.addWebapp("/tools.descartes.petsupplystore.recommender", testWorkingDir);
		...
		testTomcat.addServlet("/tools.descartes.petsupplystore.recommender", "restServlet", restServlet3);
