 ...
 */
package tools.descartes.petstore.recommender.algorithm;
...
import tools.descartes.petstore.recommender.algorithm.impl.DummyRecommender;
...
public class DummyRecommenderTest extends AbstractRecommenderTest {
	...
	/* (non-Javadoc)
	 * @see tools.descartes.petstore.recommender.algorithm.AbstractRecommenderTest#setupAlgo()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see tools.descartes.petstore.recommender.algorithm.AbstractRecommenderTest#testResults()
	 */
	@Override
